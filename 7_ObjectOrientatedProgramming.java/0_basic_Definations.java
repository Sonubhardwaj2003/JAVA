...
//Abstraction ,hiding internal details ang showing only required features.
//Encapculation ,cover all the things in a single box 
//Inheritance means specialization ,modification in somthing to get ith new features
//polymorphism means generalization, we are talk about whole group not for a specific one ,taking input from user not decleraing  in the code.

// Object ,everything in the world that is define on the basis of their property and their behaviour called objects
